...
def weight(parsed_data):
    ...
    print "tail", torenbeek.w_tail(d['n_ult'], d['s_vtail'], d['s_htail'], 'im')

    print "htail", torenbeek.w_htail(d['s_htail'], 1, d['v_d'], d['Lambda_h'], 'fixed')

    print "vtail", torenbeek.w_vtail(d['s_vtail'], 1, d['v_d'], d['Lambda_v'], 'fuselage')
